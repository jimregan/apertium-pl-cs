...
Each \textbf{e}ntry contains a \textbf{p}air, where the \textbf{l}eft contains
...
The \textbf{par} element contains a reference to another, previously defined, paradigm.
